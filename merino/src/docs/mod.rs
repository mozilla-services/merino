//! # Merino
//!
//! Merino is a web API that provides content for Firefox Suggest. Some of this
//! content comes from third parties. In this case, Merino serves as a privacy
//! preserving buffer.
//!
...
//!
//! ### [`merino-cache`](../../merino_cache/index.html)
//!
